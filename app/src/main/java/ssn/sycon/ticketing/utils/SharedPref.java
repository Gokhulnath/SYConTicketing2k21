...
public class SharedPref {
    ...
    public static Set<String> getStringSet(Context context, String key){
        return getSharePref(context).getStringSet(key,null);
    }

    public static Set<String> getStringSet(Context context, String name, String key){
       return getSharePref(context,name).getStringSet(key,null);
    }
    ...
    public static void putStringSet(Context context, String key, Set<String> value){
        getSharePref(context).edit().putStringSet(key,value).apply();
    }

    public static void putStringSet(Context context, String name, String key, Set<String> value){
        getSharePref(context,name).edit().putStringSet(key,value).apply();
    }
